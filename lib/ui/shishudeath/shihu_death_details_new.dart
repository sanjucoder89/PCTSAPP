...
class ShishuDeathDetailsNew extends StatefulWidget {
  const ShishuDeathDetailsNew({Key? key,
  ...
  @override
  State<ShishuDeathDetailsNew> createState() => _ShishuDeathDetailsNewState();
}

class _ShishuDeathDetailsNewState extends State<ShishuDeathDetailsNew> {
