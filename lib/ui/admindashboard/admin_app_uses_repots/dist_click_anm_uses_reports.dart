...
import 'package:pcts/ui/admindashboard/admin_app_uses_repots/anm_entry_report.dart';
import 'package:pcts/ui/admindashboard/admin_app_uses_repots/anm_login_butnot_enterdata_report.dart';
import 'package:pcts/ui/admindashboard/admin_app_uses_repots/chc_phc_click_anm_uses_reports.dart';
...
class DistClick_AnmUsesReports extends StatefulWidget {
  ...
  @override
  State<DistClick_AnmUsesReports> createState() => _DistClick_AnmUsesReports();
}

class _DistClick_AnmUsesReports extends State<DistClick_AnmUsesReports> {
                          ...
                          MaterialPageRoute(
                            builder: (BuildContext context) =>
                              ...
                              unitype:
                                  ...
                                  unitname:
                                  widget.unitname +" -> "+ anm_usaes_list[index]["unitname"].toString(),
                            ),
                          ));
                    },
                    child: Text(
