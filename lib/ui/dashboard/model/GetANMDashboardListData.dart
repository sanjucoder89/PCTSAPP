class GetANMDashboardListData {
  int? appVersion;
  String? message;
  bool? status;
  ResposeData? resposeData;

  GetANMDashboardListData(
      {this.appVersion, this.message, this.status, this.resposeData});

  GetANMDashboardListData.fromJson(Map<String, dynamic> json) {
...
class ResposeData {
  ...
  List<Null>? top7DistrictPerformance;
  List<IndicatorWisePerformance>? indicatorWisePerformance;
  List<Null>? top7BlockPerformance;
  List<Null>? maternalDeaths;
  List<Null>? infantDeaths;
  ...
  ResposeData.fromJson(Map<String, dynamic> json) {
    ...
    /*if (json['top7DistrictPerformance'] != null) {
      top7DistrictPerformance = <Null>[];
      json['top7DistrictPerformance'].forEach((v) {
        top7DistrictPerformance!.add(new Null.fromJson(v));
      });
    }*/
    ...
    /*if (json['top7BlockPerformance'] != null) {
      top7BlockPerformance = <Null>[];
      json['top7BlockPerformance'].forEach((v) {
        top7BlockPerformance!.add(new Null.fromJson(v));
      });
    }*/
    /*if (json['maternalDeaths'] != null) {
      maternalDeaths = <Null>[];
      json['maternalDeaths'].forEach((v) {
        maternalDeaths!.add(new Null.fromJson(v));
      });
    }
    if (json['infantDeaths'] != null) {
      infantDeaths = <Null>[];
      json['infantDeaths'].forEach((v) {
        infantDeaths!.add(new Null.fromJson(v));
      });
    }*/
