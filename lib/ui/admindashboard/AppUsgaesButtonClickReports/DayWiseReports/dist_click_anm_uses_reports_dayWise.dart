...
class DistReportDayWise extends StatefulWidget {
  ...
  final String ToDate;
  @override
  State<DistReportDayWise> createState() => _DistReportDayWise();
}

class _DistReportDayWise extends State<DistReportDayWise> {
