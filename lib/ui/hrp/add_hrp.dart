...
class _AddHRPScreenState extends State<AddHRPScreen> {
  ...
  postHbycRequest() async {
    ...
    }else if(_selectedPlacesReferCode2 == "0"){
      _showErrorPopup(Strings.prsav_centr_choose,ColorConstants.AppColorPrimary);
    }else if((_selectedPlacesReferCode2 == "9" || _selectedPlacesReferCode2 == "8" || _selectedPlacesReferCode2 == "6" || _selectedPlacesReferCode2 == "7" || _selectedPlacesReferCode2 == "5") && (_changeTitle2 == "" || _changeTitle2 =="चुनें" || _selectedBlockUnitCode2 == "0")){
      _showErrorPopup("कृपया प्रसव "+_changeTitle2 +" चुनें!",ColorConstants.AppColorPrimary);
    }else{
