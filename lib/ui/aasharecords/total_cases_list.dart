...
class TotalCasesList extends StatefulWidget {
  const TotalCasesList(
      {Key? key,
  ...
  @override
  State<TotalCasesList> createState() => _TotalCasesListState();
}

class _TotalCasesListState extends State<TotalCasesList> {
  ...
  void checkCases() {
    ...
    setState(() {
      ...
      //             pctsid_childId.setText(getResources().getString(R.string.ChildId));
      //         }
      //
      //         if(type.equals("1")||type.equals("2")||type.equals("3")){
      //             anc_pnc_imm_kramnk.setVisibility(View.VISIBLE);
      //             if(type.equals("1")){
      //                 anc_pnc_imm_kramnk.setText(R.string.anc_count);
      //                 tv_date.setText(R.string.date_of_ANC);
      //             }else if(type.equals("2")){
      //                 anc_pnc_imm_kramnk.setText(R.string.pnc_count);
      //                 tv_date.setText(R.string.pncDate);
      //             }else if(type.equals("3")){
      //                 anc_pnc_imm_kramnk.setText(R.string.immname);
      //                 tv_date.setText(R.string.immDate);
      //             }
      //         }else if(type.equals("6")){
      //             tv_date.setText(R.string.hbycdate_tag);
      //             anc_pnc_imm_kramnk.setVisibility(View.VISIBLE);
      //             anc_pnc_imm_kramnk.setText(R.string.hbycvisit_shedule);
      //         }
      //
      //         else {
      //             tv_date.setText(R.string.death_date);
      //             anc_pnc_imm_kramnk.setVisibility(View.VISIBLE);
      //             anc_pnc_imm_kramnk.setText(R.string.death_reason);
      //         }
  ...
  var _total_cases_list_url = AppConstants.app_base_url + "uspListForANMVerifyTotal";
  List response_list = [];
  Future<String> getCasesDataAPI() async {
    ...
    preferences = await SharedPreferences.getInstance();
    print("Loginunt ${preferences.getString('UnitID')}");
