...
import 'edit_mother_death_details.dart';
import 'model/GetMotherDeathListData.dart';
import 'mother_death_details.dart';

void main(){
    runApp(MothersDeathList());
}
...
class MothersDeathList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _MothersDeathList();
}
...
class _MothersDeathList extends State<MothersDeathList> {
  ...
  var _get_motherdeath_list = AppConstants.app_base_url+"DeathList";
  ...
  * */
  Future<String> getLisingAPI(String village_id) async {
    preferences = await SharedPreferences.getInstance();
    var response = await post(Uri.parse(_get_motherdeath_list), body: {
    ...
    var resBody = json.decode(response.body);
    final apiResponse = GetMotherDeathListData.fromJson(resBody);
    setState(() {
      if (apiResponse.status == true) {
  ...
  * */
  Future<String> findPrasavDataByIDAPI(String id) async {
    ...
    setState(() {
      if (apiResponse.status == true) {
        response_listing2 = resBody['ResposeData'];
        print('MotherID ${response_listing2[0]['MotherID'].toString()}');
        Navigator.push(context, MaterialPageRoute(builder: (context) => MotherDeathDetailsScreen(
            pctsID: id,
            MotherID: response_listing2[0]['MotherID'].toString(),
            StatusMother:response_listing2[0]['Status'].toString(),
            CheckWhere:"post"
        ),));
      } else {
  ...
  Future<String> OnItemListClick(String id) async {
    await EasyLoading.show(
      status: 'loading...',
      maskType: EasyLoadingMaskType.black,
    );
    ...
    setState(() {
      if (apiResponse.status == true) {
        ...
        print('MotherID ${ find_response_listing[0]['MotherID'].toString()}');
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (BuildContext context) => EditMotherDeathDetailsScreen(//MotherDeathDetailsScreen  ,EditMotherDeathDetailsScreen
                  pctsID: id,
                  MotherID: find_response_listing[0]['MotherID'].toString(),
                  StatusMother:find_response_listing[0]['Status'].toString(),
                  CheckWhere:"update"
              )
          ),
        ).then((value){setState(() {
                      ...
                      Expanded(
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(Strings.mother_death_due_cases,style: TextStyle(color: ColorConstants.white,fontSize: 14),),
                          ),
                        ),
                      ),
                            ...
                            child: Container(
                              ...
                              child: DropdownButtonHideUnderline(
                                child: DropdownButton(
                                  underline:Divider(color: ColorConstants.black,height: 1,),
                                  isDense: true,
                                  icon: Padding(
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    return InkWell(
      child:  GestureDetector(
        onTap: (){
          OnItemListClick(response_listing[index]['pctsid'].toString());
        },
        child: Container(
          child: Column(
            children: [
                    ...
                    Expanded(
                        child: Padding(
                          ...
                          child: Text(//${_mahila_vivaran_response.length == 0 ? "": getFormattedDate(_mahila_vivaran_response[index]['RegDate'].toString())}
                            response_listing[index]['pctsid'].toString(),
                            style: TextStyle(
                                fontSize: 13,
                                color: Colors.black,
                                fontWeight: FontWeight.normal),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: Padding(
                          padding: const EdgeInsets.all(5.0),
                          child: Text(
                            response_listing.length == 0 ? "" : response_listing[index]['mothername'].toString()+" w/o "+response_listing[index]['Husbname'].toString(),
                            style: TextStyle(
                                fontSize: 13,
                                color: Colors.black,
                                fontWeight: FontWeight.normal),
                  ...
                  children: [
                    ...
                    Expanded(
                        child: Padding(
                          padding: const EdgeInsets.all(5.0),
                          child: Text(//${_mahila_vivaran_response.length == 0 ? "": getFormattedDate(_mahila_vivaran_response[index]['RegDate'].toString())}
                            getFormattedDate(response_listing[index]['DeathDate'].toString()),
                            style: TextStyle(
                                fontSize: 13,
                                color: Colors.black,
                                fontWeight: FontWeight.normal),
            ...
            child: Column(
              children: <Widget>[
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(Strings.pcts_id_saish_darj_krai,textAlign:TextAlign.center,style: TextStyle(fontWeight: FontWeight.normal,color: ColorConstants.appNewBrowne,fontSize: 13),),
                  ),
                ),
