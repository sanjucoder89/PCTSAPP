...
import 'package:pcts/ui/admindashboard/model/LoginCountModel.dart';
...
class AnmLoginCount extends StatefulWidget {
  AnmLoginCount({
    Key? key,
  ...
  @override
  State<AnmLoginCount> createState() => _AnmLoginCount();
}
class _AnmLoginCount extends State<AnmLoginCount> {
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    width: 70,
                    child: const Text(Strings.anm_login_,
                        textAlign: TextAlign.center,
                        style: TextStyle(
                            fontSize: 11,
                            fontWeight: FontWeight.bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            width: MediaQuery.of(context).size.width,
                            child: const Text(Strings.entry_anm_login_,
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
  ...
  Future<String> getDataAnmNotUses() async {
    ...
    final apiResponse = LoginCountModel.fromJson(resBody);
    setState(() {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    width: 60,
                    child: Text('${anm_not_usaes_list[index]['phcchcname'].toString().trim()+"\n"+" -> "+anm_not_usaes_list[index]['unitname'].toString().trim()}',
                        textAlign: TextAlign.center,
                  ...
                  Expanded(
                      child: Row(
                        children: [
                          Expanded(child: Container(
                            //'${anm_not_usaes_list[index]['unitname'].toString().trim()}
                            child: Text('${anm_not_usaes_list[index]['ancCount'].toString().trim()}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                          ...
                          Expanded(child: Container(
                            child:  Text('${anm_not_usaes_list[index]['pncCount'].toString().trim()}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                          ...
                          Expanded(child: Container(
                            child:  Text('${anm_not_usaes_list[index]['immuCount'].toString().trim()}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                          ...
                          Expanded(child: Container(
                            child:  Text('${anm_not_usaes_list[index]['maternalDeathount'].toString().trim()}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
                          ...
                          Expanded(child: Container(
                            child:  Text('${anm_not_usaes_list[index]['infantDeathount'].toString().trim()}',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
