...
import '../motherdeath/mother_death_details.dart';
import '../prasav/after/after_prasav_expand_details.dart';
...
class PendingCasesList extends StatefulWidget {
  ...
  @override
  State<PendingCasesList> createState() => _PendingCasesListState();
}

class _PendingCasesListState extends State<PendingCasesList> {

  var _help_desk_url = AppConstants.app_base_url + "HelpDesk";
  var _logout_url = AppConstants.app_base_url + "LogoutToken";
  var _total_cases_list_url = AppConstants.app_base_url + "uspDueListForANMVerification1";
  ...
  Future<String> getCasesDataAPI() async {
    ...
    print('ASHAAutoid ${widget.ashaAutoID}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(Strings.reject_cases,
              ...
              IntrinsicHeight(child: Row(
                children: [
                  ...
                  Expanded(child: Container(child:Padding(
                    ...
                    child: Text(
                      '${response_list.length == 0 ? "" :widget.type == "5" || widget.type == "3" ||  widget.type == "6"?
                  ...
                  GestureDetector(
                    onTap: (){
                      print('asha_ancregid ${response_list[index]['ANCRegID'].toString()}');
                      print('widget.type  ${widget.type}');
                      if(widget.type == "1"){// For ANC
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AncExpandDetails(ancregid:response_list[index]['ANCRegID'].toString()),
                          ),
                        );
                      }else if(widget.type == "2"){//FOR HBNC/PNC
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AfterPrasavExpandDetails(ancregid:response_list[index]['ANCRegID'].toString()),
                          ),
                        );
                      }else if(widget.type == "3"){//FOR Shishu Tikakaran
                        Navigator.push(context, MaterialPageRoute(builder: (context) => TikaKaranDetails(
                            pctsID: response_list[index]['ChildID'].toString(),
                            infantId:  response_list[index]['InfantID'].toString()
                        ),));
                      }else if(widget.type == "4"){//FOR Shishu Death
                        Navigator.push(context, MaterialPageRoute(builder: (context) => MotherDeathDetailsScreen(
                            ...
                            StatusMother:response_list[0]['Status'].toString(),
                            CheckWhere:"post"
                        ),));
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context) => ShishuDeathDetails(
                            ...
                            DeathReportDate:response_list[index]['AncPncImmuDeathDate'].toString()
                        ),));
                      }else if(widget.type == "6"){//FOR HBYC
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    child: Container(
                      ...
                      child: Text(
                          ...
                          textAlign: TextAlign.center,
                          style: TextStyle(fontSize: 11,color:ColorConstants.AppColorPrimary)),),
                  ),
                  const VerticalDivider(
                    thickness: 1,
                    color: ColorConstants.app_yellow_color,
