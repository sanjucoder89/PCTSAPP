...
import 'DayWiseModel/DayWiseModel.dart';
import 'dist_click_anm_uses_reports_dayWise.dart'; //for date format

class AppUsagesDayWise extends StatefulWidget {
...
/*
  ...
  @override
  State<AppUsagesDayWise> createState() => _AppUsagesDayWise();
}

class _AppUsagesDayWise extends State<AppUsagesDayWise> {
  List help_response_listing = [];
  final _help_desk_url = AppConstants.app_base_url + "HelpDesk";
  late SharedPreferences preferences;
  var _PostANMUsageDaywise = AppConstants.app_base_url + "PostANMUsageDaywise";
  List anm_usaes_list = [];
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: Center(
                child: Text('एएनएम द्वारा पीसीटीएस ऐप का उपयोग',
                    style:
          ...
          Expanded(
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext ctxt, int index) {
                    ...
                    DateEnter= getFormattedDate(anm_usaes_list[index]['Enterddate'].toString().trim());
...
//
                                  ...
                                  Expanded(
                                      child: Container(
                                        child: Text(
                                            '${anm_usaes_list[index]['totalANMNotUseApp'].toString()}',
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                fontSize: 11,
                                                fontWeight: FontWeight.bold,
                                  ...
                                  Expanded(
                                      child: Container(
                                        child: Text(
                                            '${anm_usaes_list[index]['anmCount'].toString()}',
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                fontSize: 11,
                                                fontWeight: FontWeight.bold,
                                  ...
                                  Expanded(
                                      child: Container(
                                        child: Text(
                                            '${anm_usaes_list[index]['totalANMNotEnterd'].toString()}',
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                fontSize: 11,
                                                fontWeight: FontWeight.bold,
  ...
  Future<String> getPostANMAppData() async {
    ...
    print('ToDate${ToDate}');
    var response = await post(Uri.parse(_PostANMUsageDaywise), body: {
    ...
    final apiResponse = DayWiseModel.fromJson(resBody);
    setState(() {
