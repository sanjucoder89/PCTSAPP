...
import '../before/anc_expand_details.dart';
import '../before/model/GetPrasavListData.dart';
import '../before/model/GetVillageListData.dart';
import 'after_prasav_expand_details.dart';

void main(){
    runApp(AfterPrasavScreenList());
}
...
class AfterPrasavScreenList extends StatefulWidget {

  @override
  State<StatefulWidget> createState() => _AfterPrasavScreenList();
...
class _AfterPrasavScreenList extends State<AfterPrasavScreenList> {
  ...
  var _get_prasav_list = AppConstants.app_base_url+"uspPNClist";
  ...
  Future<String> findPrasavDataByIDAPI(String id) async {
    ...
    setState(() {
      if (apiResponse.status == true) {
        ...
        print('find-pctsid ${id}');
        print('find-ANCRegID ${find_response_listing[0]['ancregid'].toString()}');
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AfterPrasavExpandDetails(ancregid:find_response_listing[0]['ancregid'].toString()),//VideoPlayerScreen  SamplePlayer, VideoPlayerApp
          ),
        );
      } else {
                      ...
                      Expanded(
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: Text(Strings.pnc_k_due_cases,style: TextStyle(color: ColorConstants.white,fontSize: 14),),
                          ),
                        ),
                      ),
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AfterPrasavExpandDetails(ancregid:response_listing[index]['ANCRegID'].toString()),//VideoPlayerScreen  SamplePlayer, VideoPlayerApp
            ),
          );
        },
        child: Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(child: Padding(
                    padding: const EdgeInsets.all(5.0),
                    child: Text('${response_listing == null ? "" : getFormattedDate(response_listing[index]['Prasav_date'].toString())}',
                      style: TextStyle(fontSize: 13,color:Colors.black,fontWeight: FontWeight.normal),),
                  ))
                ],
              ),
              ...
              Row(
                ...
                children: [
                  Expanded(
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.all(5.0),
                          child: Text(
                            Strings.anc_mahaveer_due_cases,
                            style: TextStyle(
                                fontSize: 13,
                                color:ColorConstants.AppColorPrimary,
                                fontWeight: FontWeight.normal),
                  ...
                  Expanded(child: Padding(
                    padding: const EdgeInsets.all(5.0),
                    child: Text('${response_listing == null ? "" : getFormattedDate(response_listing[index]['DueANC'].toString())}',
                      style: TextStyle(fontSize: 13,color:Colors.black,fontWeight: FontWeight.normal),),
                  ))
                ],
              ),*/
