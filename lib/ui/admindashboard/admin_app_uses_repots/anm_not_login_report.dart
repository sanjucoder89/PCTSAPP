...
class AnmNotLogin extends StatefulWidget {
  AnmNotLogin({
    Key? key,
  ...
  @override
  State<AnmNotLogin> createState() => _AnmNotLogin();
}

class _AnmNotLogin extends State<AnmNotLogin> {
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            width: MediaQuery.of(context).size.width,
                            child: const Text(Strings.anm_not_login_,
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontSize: 11,
                                    fontWeight: FontWeight.bold,
